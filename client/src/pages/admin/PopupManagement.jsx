  ...
  return (
    <div className="min-h-screen bg-gray-50 p-3 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Popup Management</h1>
              <p className="text-gray-600 mt-2">Manage popups that appear on the home page</p>
            </div>
            <button
              onClick={() => setShowCreateModal(true)}
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-sm text-sm sm:text-base"
            >
              <img src={assets.add_icon} alt="Add" className="w-4 h-4 sm:w-5 sm:h-5" />
              <span className="hidden sm:inline">Create New Popup</span>
              <span className="sm:hidden">Create Popup</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid gap-4 sm:gap-6">
          {popups.length === 0 ? (
            <div className="bg-white rounded-lg shadow-sm p-8 sm:p-12 text-center">
              ...
              <p className="text-gray-500 mb-4 text-sm sm:text-base">Get started by creating your first popup to engage visitors on the home page.</p>
              <button
                onClick={() => setShowCreateModal(true)}
                  ...
                  <div className="flex-1 p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 gap-4">
                      <div className="flex-1">
                        <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">{popup.title}</h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <button
                        ...
                        className="bg-red-100 text-red-700 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium hover:bg-red-200 transition-colors"
                      >
                        Delete
                      </button>
                    </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            <h3 className="text-lg sm:text-xl font-bold mb-4">Create New Popup</h3>
      ...
      {showEditModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            <h3 className="text-lg sm:text-xl font-bold mb-4">Edit Popup</h3>

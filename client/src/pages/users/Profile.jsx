...
const Profile = () => {
  ...
  // If user doesn't have any courses, show a different view
      ...
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-blue-50">
        <div className="flex items-center justify-center min-h-screen p-4">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center max-w-2xl">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Welcome to Growth Nepal!</h1>
            <p className="text-lg text-gray-600 mb-6">
              You haven't purchased any courses yet. Start your learning journey by exploring our premium packages!
            </p>
            
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6 mb-8">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Why Choose Our Platform?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="bg-gradient-to-r from-rose-500 to-pink-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-rose-600 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                Browse Packages
              </button>
              <button
            ...
            <div className="mt-8 text-sm text-gray-500">
              <p>Once you purchase your first course, you'll have access to your full profile dashboard!</p>
            </div>
          </div>
        </div>
        <Footer />

      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 py-16'>
          ...
          <div className='lg:col-span-2 space-y-6'>
            <div className="group">
              <img className='h-14 w-auto hover:scale-105 transition-transform duration-300' src={assets.logo_dark} alt='Company Logo' />
            </div>
          ...
          <div className='space-y-6'>
            ...
            <ul className='space-y-4'>
              ...
              <li>
                <a href='/certificates' className='text-white/80 hover:text-white transition-all duration-300 text-sm flex items-center group hover:translate-x-2 transform'>
                  <svg className='w-4 h-4 mr-3 text-rose-500 group-hover:scale-110 transition-transform duration-300' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    <path strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M9 5l7 7-7 7' />
                  </svg>

    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        <form onSubmit={handleEditProfile} className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 pb-4 sm:pb-6 border-b border-gray-200">
            <img
              src={userData.imageUrl || '/default-avatar.png'}
              alt="Profile"
              className="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover border-4 border-rose-200 mx-auto sm:mx-0"
            />
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-transparent text-sm sm:text-base"
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-rose-500 focus:border-transparent text-sm sm:text-base resize-none"
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-gray-200">
            <button
              type="submit"
              className="w-full sm:w-auto bg-rose-500 text-white px-6 py-3 rounded-lg hover:bg-rose-600 transition-colors font-medium text-sm sm:text-base"
            >
              Save Changes
            </button>
            <button
              ...
              className="w-full sm:w-auto bg-gray-200 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-300 transition-colors font-medium text-sm sm:text-base"
            >
              Cancel
            </button>
          </div>

  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6 px-2 sm:px-3 md:px-4 lg:px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 text-white shadow-lg md:shadow-xl">
          ...
          {!userData.isAdmin ? (
                  purchasedCourses.length > 0 
                            ? `Latest: ${purchasedCourses[0].courseTitle || 'Recent Package'}`
        : 'No packages enrolled yet'
                ) : (
                  'Administrator'
                )}
              </p>
            ...
            {userData.isAdmin ? (
              ...
              purchasedCourses.length > 0 && (
                    <span className="bg-white/20 px-2 py-1 sm:px-2.5 md:px-3 rounded-full text-xs sm:text-sm font-medium flex items-center space-x-1">
                      ...
                      <span>{purchasedCourses.length} Package{purchasedCourses.length !== 1 ? 's' : ''}</span>
                </span>
              )
            )}
            {userData.kycStatus && (
        ...
        <div className="lg:col-span-2 bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg md:shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
        ...
        <div className="xl:col-span-2 space-y-3 sm:space-y-4 md:space-y-6">
          ...
          <div className="bg-gradient-to-r from-purple-100 to-purple-200 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg md:shadow-xl border border-purple-200 hover:shadow-2xl transition-all duration-300 animate-fade-in-up animation-delay-100">
            <div className="flex flex-col lg:flex-row items-center space-y-3 sm:space-y-4 lg:space-y-0 lg:space-x-4 md:lg:space-x-6">
              ...
              <div className="flex-shrink-0 text-center lg:text-left">
                <div className="relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto lg:mx-0">
                  ...
                  <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 bg-pink-500 rounded-full flex items-center justify-center animate-bounce" style={{ animationDelay: '0.5s' }}>
                    <FaPiggyBank className="w-2.5 h-2.5 sm:w-3 sm:h-3 md:w-3.5 md:h-3.5 text-white" />
              </div>
                  <div className="absolute -bottom-1 -left-1 sm:-bottom-2 sm:-left-2 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 bg-green-500 rounded-full flex items-center justify-center animate-bounce" style={{ animationDelay: '1s' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
            {/* Last 7 Days Earning */}
            <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg md:shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 animate-fade-in-up animation-delay-200">
            ...
            {/* All Time Earning */}
            <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg md:shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 animate-fade-in-up animation-delay-300">
              <div className="flex items-center justify-between mb-2 sm:mb-3">
            ...
            <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg md:shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 animate-fade-in-up animation-delay-400">
              <div className="flex items-center justify-between mb-2 sm:mb-3">
            ...
            {/* Wallet Balance */}
            <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg md:shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 animate-fade-in-up animation-delay-500">
              <div className="flex items-center justify-between mb-2 sm:mb-3">
          ...
          <div className="bg-white rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-6 shadow-lg md:shadow-xl border border-gray-100">
            ...
            >
                <FaGraduationCap className="text-sm sm:text-base md:text-lg lg:text-xl" />
                                  <span className="font-medium text-xs sm:text-sm">Browse Packages</span>
            </button>

...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
        ...
        <p className='text-sm md:text-base text-gray-500 mt-3'>Discover the love from us hehehe maya nai jindagi ko lakshya ho xordeu <br/> padhna padhyara kam xaina </p>
